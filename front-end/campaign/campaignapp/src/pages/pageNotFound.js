      ...
      <div className="container">
        <div className="row">
          <div className="col-md-6">
            <h2 className="tv-title-404-tm">Page Not Found</h2>
            <p className="tv-text-404-tm">The page you are looking for does not exist or has changed</p>
            <a href="/">back to home page &gt;</a>
          </div>
          <div className="col-md-6">
            <svg id="isometric" width={1302} height={952} xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 1302 952">
              ...
              <g id="nube1">
                ...
                <path fill="#036790" className="moving-svg" d="M554.97 66.81l12.765 7.598 26.637-12.867-13.812-6.968zM468.567 151.44l40.065 14.95s36.3-10.622 38.625-12.96c2.324-2.34 39.528-25.635 38.137-31.198s-15.646-39.986-15.646-39.986L536.02 59.993l-25.034 23.934-31.29 28.233-11.13 39.28z" />
